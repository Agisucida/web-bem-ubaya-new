...
<html lang="en">
  ...
  <body>
    <div class="Mendagri">
        ...
        <div id="MENDAGRI" class="container-md">
          <div class="row justify-content-md-start">
            <div class="col-lg-6" data-aos="fade-up-right" data-aos-duration="1500" data-aos-delay="150">
              <h4><strong>Kementerian Pengembangan SDM</strong></h4>
              <ul>
                <li style="color: white;">
                  <p>Mengadakan Pelatihan Terkait Dengan Sumber Daya Mahasiswa Dan Kepemimpinan Dalam Universitas Surabaya</p>
                </li>
                <li style="color: white;">
                  <p>Menaungi UKM Advertising + Kewirausahaan dan UKM Debat</p>
                </li>
              </ul>
      ...
      <!--akhir Mendagri-->
      <!--Tugas Mendagri-->
      <div id="psdm"class="Profile">
        <div class="container-md">
          <div class="row text-center">
            <h3>Profile Kementerian PSDM</h3>
          </div>
              ...
              <div class="col-md-3" data-aos="fade-down" data-aos-duration="1500">
                <div class="card text-white mb-3 text-center shadow-lg" style="max-width: 18rem">
                  ...
                  <div class="card-body">
                    ...
                    <h6 class="text-dark">Stephanie Erlia Nata</h6>
                    <a href="https://instagram.com/stephanierliaa" class="text-dark"
      ...
      <section class="ProgramKerja">
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                  <h3><strong>Training Internal</strong></h3>
                </button>
              </h2>
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <p style="color: #000000;">Training Internal adalah program kerja tahunan Kementerian PSDM untuk meningkatkan softskill sekaligus pengetahuan para mahasiswa internal UBAYA.
                    Biasanya, kegiatan ini dikemas dalam bentuk seminar atau talkshow bersama dengan narasumber dari internal UBAYA pula. Pada tahun 2020, kegiatan ini dilaksanakan dengan mengusung judul
                    "Smart Financial Tips and Money Management for Student" , sedangkan pada 2021, kegiatan ini dilakukan dengan judul <i>"Career Hacks for Better Future"</i></p>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingTwo">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                  <h3><strong>Training Eksternal PSDM:Level Up!</strong></h3>
                </button>
              </h2>
              <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <p style="color: #000000;" >Tidak hanya terbatas pada ranah internal mahasiswa UBAYA, kementerian PSDM juga membentuk program kerja yang dapat diikuti oleh kalangan mahasiswa umum melalui LevelUp!.
                    Di tahun 2020, LevelUp! diselenggarakan dengan pembahasan utama softskill mengenai Self Management dengan mengundang content creator Nia Ghania dan Karisa Djohan sebagai narasumber. Sedangkan pada 2021,
                     kegiatan ini dilaksanakan bertepatan dengan peringatan Earth Day, sekaligus berkolaborasi bersama Kementerian Sospengmas</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container-md proker">
            <div class="program">
              <div class="row text-center" data-aos="fade-down-right" data-aos-duration="500">
                <h2>Program Kerja Rutin</h2>
              </div>
            </div>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="headingThree">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="true" aria-controls="collapseOne">
                    <h3><strong>Personal Improvement</strong></h3>
                  </button>
                </h2>
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample2">
                  <div class="accordion-body">
                    <p style="color: #000000;">Selain program kerja tahunan, Kementerian PSDM juga memiliki konten-konten edukasi bernama Personal Improvement yang diupload secara rutin setiap bulannya melalui IG <a href="https://instagram.com/bem_ubaya">@bem_ubaya</a>.

                        Penasaran apa saja isi Personal Improvement itu? Langsung aja check IG <a href="https://instagram.com/bem_ubaya">@bem_ubaya</a> ya!</p>
                  </div>
                </div>
              </div>
