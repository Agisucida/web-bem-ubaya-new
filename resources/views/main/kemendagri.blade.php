...
<html lang="en">
  ...
  <body>
    <div class="Mendagri">
        ...
        <div id="MENDAGRI" class="container-md">
          <div class="row justify-content-md-start">
            <div class="col-lg-6" data-aos="fade-up-right" data-aos-duration="1500" data-aos-delay="150">
              <h4><strong>Kementerian Dalam Negeri</strong></h4>
              <ul>
                <li style="color: white;">
                  <p>Melakukan koordinasi Dengan Seluruh BEM Fakultas Dan Politeknik Yang Ada Di Universitas Surabaya</p>
                </li>
                </ul>
      ...
      <!--akhir Mendagri-->
      <!--Tugas Mendagri-->
      <div id="dagri"class="Profile">
        <div class="container-md">
          <div class="row text-center">
            <h3>Profile Kementerian Dalam Negeri</h3>
          </div>
              ...
              <div class="col-md-3" data-aos="fade-down" data-aos-duration="1500">
                <div class="card text-white mb-3 text-center shadow-lg" style="max-width: 18rem">
                  ...
                  <div class="card-body">
                    ...
                    <h6 class="text-dark">Gregorius E.P.S</h6>
                    <a href="https://instagram.com/gregorius.mario" class="text-dark"
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                  <h3 ><strong>SARASEHAN ORMAWA</strong></h3>
                </button>
              </h2>
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <p style="color: black;">
                    Sarasehan Ormawa merupakan kegiatan dimana perwakilan organisasi mahasiswa Universitas Surabaya berkumpul dalam rangka mendekatkan diri satu dengan lainnya, disertai dengan adanya forum diskusi dengan pihak rektorat untuk membahas isu-isu yang dihadapi oleh mahasiswa Universitas Surabaya.
                  </p>
                </div>
              </div>
            </div>
