...
<html lang="en">
  ...
  <body>
    <div class="Mendagri">
      ...
      <!--Akhir Navbar-->
      <!--Mendagri-->
      <div class="container mendagri">
        <div id="MENDAGRI" class="container-fluid">
          <div class="row">
            <div class="col-md-6 justify-content-md-start" data-aos="fade-up-right" data-aos-duration="1500" data-aos-delay="150">
              <h4><strong>Kementerian Olahraga</strong></h4>
              <ul>
                <li style="color: white;">
                  <p>Menaungi Seluruh UKM Olahraga Di Universitas Surabaya (UKM Badminton,Basket,Bridge,<br>Catur,Fitness,Flag Football,Futsal,Mapaus dan Sar,Renang dan Selam,Voli) </p>
                </li>
                <li style="color: white;">
                  <p>Mengadakan Kegiatan Dalam Bidang olahraga Untuk Seluruh Mahasiswa
                    Universitas Surabaya</p>
                </li>
              </ul>


              <a class="btn btn-outline-warning fw-bold" href="#olahraga" role="button">Info Lebih Lanjud</a>
            </div>
      ...
      <!--akhir Mendagri-->
      <!--Tugas Mendagri-->
      <div id="olahraga" class="Profile">
        <div class="container-md">
          <div class="row text-center">
            <h3>Profile Kementerian Olahraga</h3>
          </div>
              ...
              <div class="col-md-3" data-aos="fade-down" data-aos-duration="1500">
                <div class="card text-white mb-3 text-center shadow-lg" style="max-width: 18rem">
                  ...
                  <div class="card-body">
                    ...
                    <h6 class="text-dark">Gerald Tanzil</h6>
                    <a href="https://instagram.com/geraldtanzil7" class="text-dark"
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                  <h3><strong>UBAYA GAMES</strong></h3>
                </button>
              </h2>
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <p style="color: #000000;">UBAYA GAMES merupakan program kerja yang dilakukan setiap 2 tahun sekali oleh Kementerian Olahraga BEM-US. Program kerja ini terakhir kali telah dilaksanakan pada tahun 2018. Hal ini demikian, karena UBAYA GAMES 2020: <i> “MAY THE FRATERNITY REMAINS IN ETERNITY”</i> dengan berat hati dibatalkan, karena pandemi <i>COVID-19</i>
                    dan pada 2022 kembali di laksanakan. </p>

                  <p style="color: #000000;">Dalam hal ini, terdapat beberapa cabang olahraga, penalaran, serta seni yang dinantikan untuk diperlombakan pada kegiatan UBAYA GAMES, dan tentunya selalu ada cabang baru di setiap tahun-nya yang akan diperlombakan oleh 8 Fakultas dan 1 Politeknik Universitas Surabaya. </p>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingTwo">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                  <h3><strong>UBAYA E-Sports League: Season 2</strong></h3>
                </button>
              </h2>
              <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <p style="color: #000000;" >UBAYA Esports League merupakan kegiatan perlombaan <i>E-sports</i> pertama yang diadakan oleh Kementerian Olahraga BEM-US. Dimana terdapat 2 cabang <i>E-sports</i>yang diperlombakan pada UEL: <i>Season 1</i>  ini, yaitu <i>Mobile Legends</i> dan <i>PUBG Mobile</i></p>

                  <p style="color: #000000;">Dalam hal ini, untuk tema UEL: Season 2 adalah <i>“Strive To Thrive”</i> yang artinya adalah pematik api, sehingga dapat dilambangkan bahwa semangat Mahasiswa/i UBAYA yang tak pernah padam dalam berkompetisi secara sportif di kondisi era disrupsi ini.</p>

                  <p style="color: #000000;"><i>Last but not least,</i> UEL: Season 1 juga memiliki tagline yang membuat para peserta menjadi lebih bersemangat lagi, yaitu <i>“Survive Is Good Thrive Is Better”.</i></p>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingThree">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                  <h3><strong>FOR YOUR INSPORTMATION</strong></h3>
                </button>
              </h2>
              <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <p style="color: #000000;">
                    FOR YOUR INSPORTMATION atau yang disingkat dengan FYI merupakan sebuah informasi yang dipaparkan oleh Kementerian Olahraga di Instagram BEM-US.
                    Dalam hal ini, informasi yang dipaparkan melalui FYI merupakan informasi seputar olahraga dan Unit Kegiatan Mahasiswa Universitas Surabaya.
                  </p>
                </div>
              </div>
            </div>
