...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/png" sizes="20x20" href="img/KEUANGAN POTEH-04.webp">
  </head>
  <body>
    <div class="Mendagri">
      <!--Navbar-->
        ...
        <div id="MENDAGRI" class="container-md">
          <div class="row justify-content-md-start">
            <div class="col-lg-6" data-aos="fade-up-right" data-aos-duration="1500" data-aos-delay="150">
              <h4><strong>Kementerian Keuangan</strong></h4>
              <ul>
                <li style="color: white;">
                  <p>Mengalokasikan Dana Iuran Kemahasiswaan Kepada Ormawa Tingkat Universitas</p>
                </li>
                <li style="color: white;">
                  <p>Menyusun Anggaran Dan Kegiatan Program Kerja Bem Universitas Surabaya</p>
                </li>
                <li style="color: white;">
                  <p> Melakukan Audit Terhadap Rancangan Anggaran Dana Dalam Proposal Dan Laporan PertanggungJawaban Ormawa Tingkat Universitas</p>
                </li>
              </ul>
              <a class="btn btn-outline-warning" href="#keuangan" role="button">INFO LEBIH LANJUT</a>
            </div>
            <div class="col-lg-6" data-aos="fade-up-left" data-aos-duration="1500" data-aos-delay="150">
              <img src="img/KEUANGAN POTEH-04.webp" alt="" style="width: 15rem" />
            </div>
          </div>
        </div>
      </div>
      ...
      <!--awal profile mentri-->
      <div id="keuangan"class="Profile">
        <div class="container-md">
          <div class="row text-center">
            <h3>Profile Kementerian Keuangan</h3>
          </div>
              ...
              <div class="col-md-3" data-aos="fade-down" data-aos-duration="1500">
                <div class="card text-white mb-3 text-center shadow-lg" style="max-width: 18rem">
                  <div class="card-header">
                    <img src="img/Annisa Hasanah Indarviningtyas, 130521003, Menteri Keuangan.webp.webp" class="img-fluid rounded-circle" alt="1" />
                  </div>
                  <div class="card-body">
                    <h5 class="card-title text-dark">Menteri</h5>
                    <h6 class="text-dark">Annisa Hasanah Indarviningtyas</h6>
                    <a href="instagram.com/michannael" class="text-dark"
            ...
            <div class="row justify-content-start">
              <div class="col-md-3" data-aos="fade-up-right" data-aos-duration="1500" data-aos-delay="300">
                <div class="card text-white bg-light mb-3 text-center shadow-lg" style="max-width: 18rem">
                  <div class="card-header">
                    <img src="img/KEUANGAN POTEH-04.webp" class="img-fluid rounded-circle" alt="1" />
                  </div>
                  <div class="card-body">
