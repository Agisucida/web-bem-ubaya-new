...
<html lang="en">
  ...
  <body>
    <div class="Mendagri">
        ...
        <div id="MENDAGRI" class="container-md">
          <div class="row justify-content-md-start">
            <div class="col-lg-6" data-aos="fade-up-right" data-aos-duration="1500" data-aos-delay="150">
              <h4><strong>Kementerian Nasionalisme</strong></h4>
              <ul>
                <li style="color: white;">
                  <p>Mengadakan Kegiatan Kemahasiswaan Yang Memelihara Semangat Nasionalisme Mahasiswa Universitas Surabaya</p>
                </li>
                <li style="color: white;">
                  <p>Mengedukasi Paham Kebangsaan Dan Mengkaji Isu-Isu Nasional Melalui Akun Sosial Media<a href="https://instagram.com/nasionalismebemus" style="color: blue;" > @NasionalismeBemus</a></p>
                </li>
                <li style="color: white;">
                  <p> Menaungi UKM Sat-Menwa 815 Universitas Surabaya</p>
                </li>
              </ul>
              <a class="btn btn-outline-warning" href="#nasional" role="button">INFO LEBIH LANJUT</a>
            </div>
      ...
      <div id="nasional"class="Profile">
        <div class="container-md">
          <div class="row text-center">
            <h3>Profile Kementerian Nasionalisme</h3>
          </div>
              ...
              <div class="col-md-3" data-aos="fade-down" data-aos-duration="1500">
                <div class="card text-white mb-3 text-center shadow-lg" style="max-width: 18rem">
                  ...
                  <div class="card-body">
                    ...
                    <h6 class="text-dark">Albert Christian Meliangan</h6>
                    <a href="https://instagram.com/albert.chm" class="text-dark"
                      ><svg xmlns="https://instagram.com/albert.chm?igshid=YmMyMTA2M2Y=" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                        <path
            ...
            <div class="accordion-item ">
              <h2 class="accordion-header " id="flush-headingOne">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                  <h3 ><strong>NATIONFEST</strong></h3>
                </button>
              </h2>
              <div id="flush-collapseOne" class="accordion-collapse collapse text-dark" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">
                  <p style="color: black;">
                    NATIONFEST merupakan program kerja tahunan Kementerian Nasionalisme yang diselenggarakan oleh Badan Eksekutif Mahasiswa Universitas Surabaya (BEM-US) yang bertujuan untuk meningkatkan nilai-nilai nasionalisme di lingkungan Universitas Surabaya. NATIONFEST diadakan dalam bentuk gelar wicara <i>(talkshow)</i> dengan narasumber yang memaparkan isu-isu hingga upaya meningkatkan rasa kecintaan kawula muda kepada bangsa Indonesia. Selain itu, NATIONFEST diawali dengan berbagai penampilan baik dari pagelaran seni, budaya, alat musik, tari, hingga kuliner yang berasal dari Indonesia untuk memperkenalkan kepada lingkungan Universitas Surabaya terkait betapa kaya dan uniknya budaya yang dimiliki oleh Bangsa Indonesia.
                  </p>
                  <p style="color: black;">
                    Kementerian Nasionalisme sebagai kementerian termuda di Badan Eksekutif Mahasiswa Universitas Surabaya mengadakan NATIONFEST pertama kali diselenggarakan pada tahun 2019 secara offline dengan tema <i> “Portrait of Indonesia” </i>dimana mengundang Pandji Pragiwaksono sebagai pembicara dan disertai bazar kuliner nusantara. Kemudian pandemi melanda menyebabkan seluruh kegiatan salah satunya dalam ranah pendidikan wajib untuk diselenggarakan secara online yang tentunya berdampak pada kegiatan NATIONFEST pada tahun 2020 dan 2021. Untuk yang penasaran dan mau tahu info lebih lanjut... yuk! mampir ke Instagram nationfest (@nationfest2021) dan Instagram <a href="https://instagram.com/nationfest2021"> Nasionalisme</a>
                  </p>
                </div>
              </div>
            </div>
