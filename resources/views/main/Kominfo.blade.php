  ...
  <body>
    <div class="Mendagri">
      ...
      <div class="container-fluid mendagri">
        <div id="MENDAGRI" class="container-md  kominfo">
          <div class="row justify-content-md-start">
            <div class="col-lg-6" data-aos="fade-up-right" data-aos-duration="1500" data-aos-delay="150">
              <h4><strong>Kementerian Komunikasi Dan Informasi</strong></h4>
              <ul>
                <li style="color: white;">
                  <p>Melakukan Komunikasi Dan Penyampaian Informasi Terkait Kegiatan Kepada Seluruh Mahasiswa Universitas Surabaya</p>
                </li>
                <li style="color: white;">
                  <p>Mengelola E-mail Dan Seluruh Akun Media Sosial BEM Universitas Surabaya</p>
                </li>
              </ul>
      ...
      <!--awal profile mentri-->
      <div id="kominfo"class="Profile">
        <div class="container-md">
          <div class="row text-center">
            <h3>Profile Kementerian KOMINFO</h3>
          </div>
              ...
              <div class="col-md-3" data-aos="fade-down" data-aos-duration="1500">
                <div class="card text-white mb-3 text-center shadow-lg" style="max-width: 18rem">
                  ...
                  <div class="card-body">
                    ...
                    <h6 class="text-dark">Muhammad Ikhsan</h6>
                    <a href="https://instagram.com/m_iksan273"
                     class="text-dark"
