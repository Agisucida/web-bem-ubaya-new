...
<html lang="en">
  <head>
    ...
    <title>SEKRETARIS NEGARA</title>
    <link rel="stylesheet" href="styles/owl.carousel.min.css" />
    <link rel="stylesheet" href="styles/owl.theme.default.min.css" />
    <link rel="icon" type="image/png" sizes="20x20" href="img/SESNEG-08.webp">
  </head>
  <body>
    <div class="Mendagri">
      <!--Navbar-->
            ...
            <div id="Navbar" class="container sticky-md-top">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link" href="/">Tentang Kabinet</a>
                    </ul>
                  </li>
                </ul>
              </div>
        ...
        <div id="MENDAGRI" class="container-md">
          <div class="row justify-content-md-start">
            <div class="col-lg-6" data-aos="fade-up-right" data-aos-duration="1500" data-aos-delay="150">
              <h4><strong>Kementerian Sekretaris Negara</strong></h4>
              <ul>
                <li style="color: white;">
                  <p> Menyusun Proposal Dan Laporan<br> Pertanggung Jawaban Kegiatan Program kerja <br> BEM Universitas Surabaya</p>
                </li>
                <li style="color: white;">
                  <p>Melakukan Audit Proposal Dan Laporan Pertanggung Jawaban Kegiatan Program Kerja Ormawa Tingkat Universitas </p>
                </li>
                <li style="color: white;">
                  <p> Melakukan Kegiatan Surat Menyurat</p>
                </li>
              </ul>

              <a class="btn btn-outline-warning" href="#sesneg" role="button">INFO LEBIH LANJUT</a>
            </div>
            <div class="col-lg-6" data-aos="fade-up-left" data-aos-duration="1500" data-aos-delay="150">
              <img src="img/SESNEG-08.webp" alt="" style="width: 20rem" />
            </div>
          </div>
        </div>
      </div>
      ...
      <!--awal profile mentri-->
      <div id="sesneg"class="Profile">
        <div class="container-md">
          <div class="row text-center">
            <h3>Profile Kementerian Sekretaris Negara</h3>
          </div>
              ...
              <div class="col-md-3" data-aos="fade-down" data-aos-duration="1500">
                <div class="card text-white mb-3 text-center shadow-lg" style="max-width: 18rem">
                  <div class="card-header">
                    <img src="img/Adeline Alyssa, 130221231, Menteri Sekretaris Negara.webp" class="img-fluid rounded-circle" alt="1" />
                  </div>
                  <div class="card-body">
                    <h5 class="card-title text-dark">Menteri</h5>
                    <h6 class="text-dark">Adeline Aisyah Alyssa Tjandra</h6>
                    <a href="https://instagram.com/adelinelyssa_?igshid=YmMyMTA2M2Y=" class="text-dark"
            ...
            <div class="row justify-content-start">
              <div class="col-md-3" data-aos="fade-up-right" data-aos-duration="1500" data-aos-delay="300">
                <div class="card text-white bg-light mb-3 text-center shadow-lg" style="max-width: 18rem">
                  <div class="card-header">
                    <img src="img/SESNEG-08.webp" class="img-fluid rounded-circle" alt="1" />
                  </div>
                  <div class="card-body">
      ...
      {{-- <div class="containerGallery">
        ...
        <div class="owl-carousel owl-theme">
          ...
          <div class="item"><img src="img/UNGU.webp" alt="" /></div>
