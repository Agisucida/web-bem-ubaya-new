      ...
      <div class="BigContainer">
        ...
        <div id="LOGIN" class="container-md">
            <div class="row text-center">
              <h2 style="color: white; " ><strong>Selamat Anda Berhasil Mendaftar Sebagai Staff Bem Ubaya!</strong></h2>
              <p><strong>Silahkan Menunggu informasi mengenai interview secara berkala ya di ig <a href="https://instagram.com/bem_ubaya"></a> dan juga di website resmi bem ubaya</strong></p>


            </div>
            <div class="text-center">
              <a href="http://instagram.com/bem_ubaya"><button type="button" class="btn btn-primary instagram" >Instagram</button></a>
              <a href="/"><button type="button" class="btn btn-primary web" >Kembali ke Home</button></a>
            </div>
        </div>
        <!-- Login-->
        <script src="js/jquery.vide.js"></script>
