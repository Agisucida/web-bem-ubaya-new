    ...
    <div class="sticky-md-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div id="Navbar" class="container sticky-md-top">
                <a><img src="img/logoBEM.webp" alt="" width="30" style="margin-right: 10px;" />BEM
    ...
    <div class="container-md register">
        <div id="REGISTER" class="container-md">
            ...
            <div class="row justify-content-md-start">
                ...
                <form action="{{ route('daftarAdmin.action') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control input-sm" type="text" id="nrp" name="nrp"
                            value="{{ old('name') }}"><br />
                        <span style="color:red">
                            @error('name')
                                {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <select id="kementrian" name="kementrian">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control input-sm" type="password" id="password_confirmation" name="password_confirmation"
                            value="{{ old('name') }}" /><br />
                        <span style="color:red">
                            @error('name')
                                {{ $message }}
